...
#define FFMPEG_CONFIGURATION "--prefix=/ffmpeg/release_static --disable-debug --disable-shared --enable-static --enable-memalign-hack --enable-gpl --enable-yasm --enable-libgsm --enable-postproc --enable-pthreads --enable-version3 --enable-avfilter --enable-avisynth --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libtheora --enable-libvorbis --enable-libx264 --enable-libxvid --extra-cflags=-fno-common"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define FFMPEG_DATADIR "/ffmpeg/release_static/share/ffmpeg"
#define CC_TYPE "gcc"
